        ...
        <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="group">
              ...
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Weekly Curated Collections</h3>
              <p className="text-stone-300 text-sm font-light leading-relaxed">Themed recommended collections updated weekly</p>
            </div>

            <div className="group">
              <div className="w-12 h-12 bg-amber-500/8 border border-amber-500/15 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:border-amber-500/25 transition-colors">
                <svg className="w-6 h-6 text-amber-400/45" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>
              </div>
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Free Explore</h3>
            ...
            <div className="group">
              ...
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Image Interactions</h3>
            ...
            <div className="group">
              <div className="w-12 h-12 bg-amber-500/8 border border-amber-500/15 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:border-amber-500/25 transition-colors">
                <svg className="w-6 h-6 text-amber-400/45" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" /></svg>
              </div>
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Collection Management</h3>
            ...
            <div className="group">
              ...
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">AI Art Assistant</h3>
            ...
            <div className="group">
              ...
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Social Features</h3>
            ...
            <div className="group">
              <div className="w-12 h-12 bg-amber-500/8 border border-amber-500/15 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:border-amber-500/25 transition-colors">
                <svg className="w-6 h-6 text-amber-400/45" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zm-7.518-.267A8.25 8.25 0 1120.25 10.5M8.288 14.212A5.25 5.25 0 1117.25 10.5" /></svg>
              </div>
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Interactive UI</h3>
              <p className="text-stone-300 text-sm font-light leading-relaxed">Intuitive gestures, smooth animations, and responsive touch controls</p>
            </div>
            ...
            <div className="group">
              ...
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Mobile-First Design</h3>
              <p className="text-stone-300 text-sm font-light leading-relaxed">Optimized mobile experience with progressive web app features</p>
            </div>

            <div className="group">
              <div className="w-12 h-12 bg-amber-500/8 border border-amber-500/15 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:border-amber-500/25 transition-colors">
                <svg className="w-6 h-6 text-amber-400/45" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg>
              </div>
              <h3 className="text-amber-200/45 font-light mb-2 tracking-wide">Performance Optimization</h3>
              <p className="text-stone-300 text-sm font-light leading-relaxed">Lightning-fast loading with lazy loading and optimized image delivery</p>
            </div>
          </div>
        </div>
