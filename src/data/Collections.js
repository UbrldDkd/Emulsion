// Collections.js - Simple art collections by movement

export const Collections = [
  {
    movement: "Impressionism",
    period: "19th Century",
    description: "Focused on capturing light, color, and fleeting moments with visible brushstrokes.",
    paintings: [
      {
        title: "Water Lilies",
        artist: "Claude Monet",
  ...
  },
  {
    ...
    description: "Emphasized emotion, individualism, and dramatic landscapes.",
    paintings: [
      {
  ...
  },
  {
    ...
    description: "Japanese woodblock prints depicting landscapes, kabuki actors, and daily life.",
    paintings: [
      {
